 ...
 * @author GAGAN
 */
public class homepageCS extends javax.swing.JFrame {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(resoursepanel, javax.swing.GroupLayout.DEFAULT_SIZE, 0, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
           parentpanel.removeAll(); 
               ...
               populate("FLAT");
               updateinfo("FLAT");
               jLabel8.setText("Post a question in FLAT");
    ...
    private void jLabel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseClicked
      parentpanel.removeAll(); 
               ...
               jLabel8.setText("Post a question in MP");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jLabel8.getText().equals("Post a question in FLAT"))
        {
            postquestion(question,"FLAT");
        }
        else if(jLabel8.getText().equals("Post a question in MP"))
         {
              postquestion(question,"MP");
         }
        jTextArea1.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(homepageCS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new homepageCS(null).setVisible(true);
            }
        });
    }
